...
public class TaskMapper {
    ...
    public TaskMapper(UserRepository userRepository, ProjectRepository projectRepository, ColumnRepository columnRepository) {
    ...
    public TaskEntity toEntity(TaskRequestDto requestDto) {
        ...
        ColumnEntity column = columnRepository.findById(requestDto.columnId())
                .orElseThrow(() -> new NoSuchElementException());
